    ...
    Player.prototype.handleInput = function(keycode) {
        switch (keycode) {
            case "left":
                ...
                } else if (obstruction.barrier() === false && this.x === OBSTRUCT_X && this.y < OBSTRUCT_Y) {} else if (obstruction.barrier() === false && this.x - HORIZONTAL > BOUNDX_LEFT) {
                    this.x -= HORIZONTAL;
                }
                break;
            case "right":
                ...
                } else if (obstruction.barrier() === false && this.x + HORIZONTAL > (OBSTRUCT_X - OBSTRUCT_WIDTH) && this.y < OBSTRUCT_Y) {} else if (obstruction.barrier() === false && this.x + HORIZONTAL < BOUNDX_RIGHT) {
                    this.x += HORIZONTAL;
                }
                break;
            case "up":
                ...
                if (this.x === (OBSTRUCT_X) && obstruction.barrier() === true && this.y - VERTICAL < (OBSTRUCT_Y + OBSTRUCT_HEIGHT)) {} else if (this.x === (OBSTRUCT_X) && obstruction.barrier() === true && this.y.VERTICAL > (OBSTRUCT_Y + OBSTRUCT_HEIGHT) && this.y - VERTICAL < BOUNDY_TOP) {
                ...
                } else if (this.x === (OBSTRUCT_X) && obstruction.barrier() === false && this.y - VERTICAL < BOUNDY_TOP) {} else if (this.x !== (OBSTRUCT_X) && obstruction.barrier() === false && this.y - VERTICAL < OBSTRUCT_Y) {} else {
                    this.y -= VERTICAL;
                }
                break;
            case "down":
                if (this.y + VERTICAL > BOUNDY_BOTTOM) {} else {
                    this.y += VERTICAL;
                }
                break;
            case "space":
